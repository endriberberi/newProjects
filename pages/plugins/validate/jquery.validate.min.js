...
$.validator.setDefaults({
    highlight: function(element) {
        ...
        else if ($(element).closest('section').length) {
    ...
    invalidHandler: function(evt, validator){
    	...
    	if (errors && form.is('[data-validation-message="alert"]')) {
...
$.validator.addMethod("passwordstrength", function(value) {
   ...
   return /^[A-Za-z0-9\d!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~]*$/.test(value) && /[A-Z]/.test(value) && /\d/.test(value);
       // consists of only these // has a lowercase letter // has a digit
});

$.validator.addMethod("username", function(value) {
   return /^[A-Za-z0-9\d.@]*$/ig.test(value);
});

$.validator.addMethod("namefieldsanity", function(value, element) {
    if ($(element).val() !== '') {
        return /^((?![<|>\/\\"{|\}]).)+$/i.test( value );
    }else{
        return true;
...
$.validator.addMethod("htmlsanity", function(value, element) {
    if ($(element).val() !== '') {
        return /^((?![<|>\/\\{|\}]).|\n)+$/i.test( value );
    }else{
        return true;
