...
function InternalSearchResultModule_onRender() {
	global $session,$event;
	...
	$getTabData["data"][$indexTab]["tab_inc_clients_data"] = "<Include SRC=\"{{NEMODULES_PATH}}InternalSearchResultModule/template_default.html\">";
