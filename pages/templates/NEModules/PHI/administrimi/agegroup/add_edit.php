...
IF (ISSET($post_id) AND ($post_id != ""))
   {
    unset($tab);
    $kushti_where        = 'WHERE id_agegroup = "'.ValidateVarFun::f_real_escape_string($post_id).'"';
    $tab['tab_name']     = 'phi_agegroup';            //*emri i tabeles ku do behet select
...
//Grid_form -----------------------------------------------------------------------------------------------------------
  ...
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['maxlength']        = '2';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="1,1,0,0,0,0" etiketa="{{order_form_alert_mesg}}"';
  $Grid_form['data'][$nr]['width']            = '8';
