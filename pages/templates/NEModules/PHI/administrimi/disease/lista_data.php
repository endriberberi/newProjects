  ...
  IF ($nr_rec_total > 0)
     {
      ...
      $kolonat_fusha[] = "id_disease";       $kolonat_etiketa[] = WebApp::getVar("id_mesg");
      $kolonat_fusha[] = "name";             $kolonat_etiketa[] = WebApp::getVar("emertimi_mesg");
      $kolonat_fusha[] = "reporting_time";   $kolonat_etiketa[] = WebApp::getVar("reporting_time_mesg");
      $kolonat_fusha[] = "code";             $kolonat_etiketa[] = WebApp::getVar("code_mesg");
      $kolonat_fusha[] = "code_icd9";        $kolonat_etiketa[] = WebApp::getVar("code_icd9_mesg");
      $kolonat_fusha[] = "code_icd10";       $kolonat_etiketa[] = WebApp::getVar("code_icd10_mesg");
      $kolonat_fusha[] = "record_status";    $kolonat_etiketa[] = WebApp::getVar("statusi_mesg");

      IF ($exp_data == "Y")
         {
          $kolonat_fusha[] = "description";      $kolonat_etiketa[] = WebApp::getVar("description_mesg");
          $kolonat_fusha[] = "case_definition";  $kolonat_etiketa[] = WebApp::getVar("case_definition_mesg");
         }
  ...
  IF ($nr_rec_total > 0)
     {
      ...
      //futemi ne kursorin e te dhenave ----------------------------------------------------------------------------------
        $sql = 'SELECT id_disease                                          as id_sel,
                       IF (name             IS NULL, "", name)             as name,
                       IF (code             IS NULL, "", code)             as code,
                       IF (code_icd9        IS NULL, "", code_icd9)        as code_icd9,
                       IF (code_icd10       IS NULL, "", code_icd10)       as code_icd10,
                       IF (reporting_time   IS NULL, "", reporting_time)   as reporting_time_sel,
                       IF (description      IS NULL, "", description)      as description,
                       IF (case_definition  IS NULL, "", case_definition)  as case_definition,
        ...
        WHILE (!$rs_list->EOF())
	          {
               ...
               $code_icd9            = $rs_list->Field('code_icd9');
               $code_icd10           = $rs_list->Field('code_icd10');
               $reporting_time_sel   = $rs_list->Field('reporting_time_sel');
               $description          = $rs_list->Field('description');
               $case_definition      = $rs_list->Field('case_definition');
