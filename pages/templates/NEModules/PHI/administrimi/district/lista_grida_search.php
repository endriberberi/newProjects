...
//GRID SEARCH ------------------------------------------------------------------------------------------------------------
  ...
  //id_region --------------------------------------------------------------------------------------------------------
    unset($lov);
    $lov["name"]          = "id_region";
    IF ($G_APP_VARS["s_id_region"] != "")
       {
        $lov["id_select"] = ValidateVarFun::f_real_escape_string($G_APP_VARS["s_id_region"]);
       }
    ELSE
       {
        $lov["id_select"] = "-1";
       }
    $lov["object_name"]   = "s_id_region";
    $lov["valid"]         = "0,0,0,0,0,0";
    $lov["only_options"]  = "Y";
    $lov_s_id_region      = f_app_lov_default_values($lov);
  //record_status --------------------------------------------------------------------------------------------------------
  ...
  $Grid_form['data'][$nr]['value']            = '{{id_region_mesg}}:';
  $Grid_form['data'][$nr]['for']              = 's_id_region';
  $Grid_form['data'][$nr]['id']               = 'id_s_id_region_label';
  $Grid_form['data'][$nr]['other_attributes'] = '';
  $Grid_form['data'][$nr]['width']            = '3';
  
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'select';
  $Grid_form['data'][$nr]['name']             = 's_id_region';
  $Grid_form['data'][$nr]['value']            = $lov_s_id_region;
  $Grid_form['data'][$nr]['id']               = 'id_s_id_region';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,0,0,0" etiketa="{{id_region_mesg}}"';
  $Grid_form['data'][$nr]['placeholder']      = '';
