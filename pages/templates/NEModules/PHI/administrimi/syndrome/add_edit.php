...
IF (ISSET($post_id) AND ($post_id != ""))
   {
    unset($tab);
    $kushti_where        = 'WHERE id_syndrome = "'.ValidateVarFun::f_real_escape_string($post_id).'"';
    $tab['tab_name']     = 'phi_syndrome';            //*emri i tabeles ku do behet select
...
//Grid_form -----------------------------------------------------------------------------------------------------------
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = $yll.'{{order_form_alert_mesg}}:';
  $Grid_form['data'][$nr]['for']              = 'id_order_form_alert';
  $Grid_form['data'][$nr]['id']               = 'id_order_form_alert_label';
  $Grid_form['data'][$nr]['other_attributes'] = '';
  $Grid_form['data'][$nr]['width']            = $width_lab;

  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = $obj_type_text;
  $Grid_form['data'][$nr]['name']             = 'order_form_alert';
  $Grid_form['data'][$nr]['value']            = HTMLSPECIALCHARS($val_rec['order_form_alert'][0]['vl']).'';
  $Grid_form['data'][$nr]['id']               = 'id_order_form_alert';
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['maxlength']        = '3';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="1,1,0,0,0,1" etiketa="{{order_form_alert_mesg}}"';
  $Grid_form['data'][$nr]['width']            = $width_obj;
  ...
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['other_attributes'] = ' rows="5" valid="0,0,0,0,0,0" etiketa="{{description_mesg}}"';
  $Grid_form['data'][$nr]['width']            = 12;
