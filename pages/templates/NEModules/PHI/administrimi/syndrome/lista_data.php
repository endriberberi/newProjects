  ...
  IF ($nr_rec_total > 0)
     {
      ...
      $kolonat_fusha[] = "id_syndrome";      $kolonat_etiketa[] = WebApp::getVar("id_mesg");
      $kolonat_fusha[] = "name";             $kolonat_etiketa[] = WebApp::getVar("emertimi_mesg");
      $kolonat_fusha[] = "order_form_alert"; $kolonat_etiketa[] = WebApp::getVar("order_form_alert_mesg");
  ...
  IF ($nr_rec_total > 0)
     {
      ...
      //futemi ne kursorin e te dhenave ----------------------------------------------------------------------------------
        $sql = 'SELECT id_syndrome                                         as id_sel,
                       IF (name             IS NULL, "", name)             as name,
                       IF (code             IS NULL, "", code)             as code,
                       IF (order_form_alert IS NULL, "", order_form_alert) as order_form_alert_sel,
        ...
        WHILE (!$rs_list->EOF())
	          {
               ...
               $order_form_alert_sel = $rs_list->Field('order_form_alert_sel');
               ...
               //array me datat ------------------------------------------------------------------------------------------
                 ...
                 $cel_sel['link_att']         = '';
                 $cel_sel['data_type']        = 'label'; //label/icon
                 $cel_sel['vl']               = $order_form_alert_sel;
                 $cel_sel['vl_db']            = '';
                 $cel_sel['vlf']              = '';
                 $cel_sel['bold']             = '';
                 $cel_sel['align']            = '';
