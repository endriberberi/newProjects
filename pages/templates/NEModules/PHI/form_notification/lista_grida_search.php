...
//GRID SEARCH ------------------------------------------------------------------------------------------------------------
  ...
  //s_id_branch ----------------------------------------------------------------------------------------------------------
    ...
    $lov["filter"]        = "WHERE id_branch IN (".ValidateVarFun::f_real_escape_string($user_dega_qendra["view_branch_ids"]).") ";
  ...
  //id_reporting_entity --------------------------------------------------------------------------------------------------
    ...
    IF ($user_dega_qendra["reporting_entity_ids"] != "")
       {
        $lov["filter"] .= " AND id_reporting_entity IN (".ValidateVarFun::f_real_escape_string($user_dega_qendra["reporting_entity_ids"]).")";
       }
  ...
  //s_id_disease -------------------------------------------------------------------------------------------
    unset($lov);
    $lov["name"] = "id_disease";
    IF ($G_APP_VARS["s_id_disease"] != "")
       {
        $lov["id_select"] = ValidateVarFun::f_real_escape_string($G_APP_VARS["s_id_disease"]);
       }
    ELSE
       {
        $lov["id_select"] = "-1";
    ...
    $lov["object_name"]   = "s_id_disease";
    $lov["valid"]         = "0,0,0,0,0,0";
    $lov["only_options"]  = "Y";
    $lov_s_id_disease     = f_app_lov_default_values($lov);
  //s_id_disease -------------------------------------------------------------------------------------------
...
//formatohen datat -------------------------------------------------------------------------------------------------------
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = '{{date_of_completion_sh_mesg}} {{nga_mesg}}:';
  ...
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,1,0,0" etiketa="{{date_of_completion_sh_mesg}} {{nga_mesg}}"';
  $Grid_form['data'][$nr]['width']            = $width_obj;
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = '{{date_of_completion_sh_mesg}} {{deri_mesg}}:';
  ...
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['maxlength']        = '10';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,1,0,0" etiketa="{{date_of_completion_sh_mesg}} {{deri_mesg}}"';
  $Grid_form['data'][$nr]['width']            = $width_obj;
  ...
  $Grid_form['data'][$nr]['value']            = HTMLSPECIALCHARS($G_APP_VARS["s_form_number"]).'';
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = '{{id_disease_mesg}}:';
  $Grid_form['data'][$nr]['for']              = 'id_s_id_disease';
  $Grid_form['data'][$nr]['id']               = 'id_s_id_disease_label';
  $Grid_form['data'][$nr]['other_attributes'] = '';
  $Grid_form['data'][$nr]['width']            = $width_lab;
  
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'select';
  $Grid_form['data'][$nr]['name']             = 's_id_disease';
  $Grid_form['data'][$nr]['value']            = $lov_s_id_disease;
  $Grid_form['data'][$nr]['id']               = 'id_s_id_disease';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,0,0,0" etiketa="{{id_disease_mesg}}"';
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['filter']           = 'Y';
  $Grid_form['data'][$nr]['width']            = $width_obj;
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = '{{person_first_name_mesg}}:';
  $Grid_form['data'][$nr]['for']              = 'id_s_person_first_name';
  $Grid_form['data'][$nr]['id']               = 'id_s_person_first_name_label';
  $Grid_form['data'][$nr]['other_attributes'] = '';
  $Grid_form['data'][$nr]['width']            = $width_lab;

  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'text';
  $Grid_form['data'][$nr]['name']             = 's_person_first_name';
  $Grid_form['data'][$nr]['value']            = HTMLSPECIALCHARS($G_APP_VARS["s_person_first_name"]).'';
  $Grid_form['data'][$nr]['id']               = 'id_s_person_first_name';
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['maxlength']        = '20';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,0,0,0" etiketa="{{person_first_name_mesg}}"';
  $Grid_form['data'][$nr]['width']            = $width_obj;
  ...
  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'label';
  $Grid_form['data'][$nr]['value']            = '{{person_last_name_mesg}}:';
  $Grid_form['data'][$nr]['for']              = 'id_s_person_last_name';
  $Grid_form['data'][$nr]['id']               = 'id_s_person_last_name_label';
  $Grid_form['data'][$nr]['other_attributes'] = '';
  $Grid_form['data'][$nr]['width']            = $width_lab;

  $nr = $nr + 1;
  $Grid_form['data'][$nr]['type']             = 'text';
  $Grid_form['data'][$nr]['name']             = 's_person_last_name';
  $Grid_form['data'][$nr]['value']            = HTMLSPECIALCHARS($G_APP_VARS["s_person_last_name"]).'';
  $Grid_form['data'][$nr]['id']               = 'id_s_person_last_name';
  $Grid_form['data'][$nr]['placeholder']      = '';
  $Grid_form['data'][$nr]['maxlength']        = '20';
  $Grid_form['data'][$nr]['other_attributes'] = 'valid="0,0,0,0,0,0" etiketa="{{person_last_name_mesg}}"';
  $Grid_form['data'][$nr]['width']            = $width_obj;
